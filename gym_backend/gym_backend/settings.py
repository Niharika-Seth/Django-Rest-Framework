...
SECRET_KEY = 'django-insecure-sr#_%za1(4f+gsc=^j^x01vo))rjc3=!03%l(_p*io=q41-s#5'
...
# If frontend on same origin, fine. If cross-origin, adjust CORS and CSRF_TRUSTED_ORIGINS.
